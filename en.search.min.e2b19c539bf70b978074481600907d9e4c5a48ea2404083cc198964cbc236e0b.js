'use strict';(function(){const searchDataURL='/en.search-data.min.5e566aa4745ab6be7ced183a116a619707fdd0e4061fd5a3c584f52ee5c5a61c.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
