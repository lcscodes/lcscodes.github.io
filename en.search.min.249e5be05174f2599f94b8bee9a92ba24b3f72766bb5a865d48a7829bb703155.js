'use strict';(function(){const searchDataURL='/en.search-data.min.65d7d15bdbe6674ce0144b23cbc2513b46f4b89d3772cca9513f1b3678be19c8.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
