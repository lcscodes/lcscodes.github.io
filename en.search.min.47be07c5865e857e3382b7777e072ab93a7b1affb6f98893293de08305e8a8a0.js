'use strict';(function(){const searchDataURL='/en.search-data.min.46092557381ebd5476872634420875178ef983fca3085227fe3c5e8fd018b4ef.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
