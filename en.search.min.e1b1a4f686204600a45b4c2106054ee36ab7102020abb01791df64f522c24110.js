'use strict';(function(){const searchDataURL='/en.search-data.min.e5ea28456a68a5c0ed54a68af632e2e4a94216e9ac679a6c52d330af159b0b36.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
