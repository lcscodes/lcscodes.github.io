'use strict';(function(){const searchDataURL='/en.search-data.min.3a77e706e1aa6e0231963886337cb222a5c3e26c2684a10fa8dc970e5a9f42fd.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
