'use strict';(function(){const searchDataURL='/en.search-data.min.4c80008c8658bfc24a1ec33509f8d6c462a4bbd5856d8a8e94b6be00d0c563cb.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
