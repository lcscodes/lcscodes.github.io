'use strict';(function(){const searchDataURL='/en.search-data.min.605f9ec87f39794a000fe632ea0d9d51410daf06db15a964bab8cee0ccdde126.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
